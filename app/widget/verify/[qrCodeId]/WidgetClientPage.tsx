...
export default function WidgetClientPage({ widgetData }: WidgetProps) {
  ...
  const [step, setStep] = useState<"input" | "verifying" | "success" | "fail">(
    "input",
  );
      ...
      <div style={{ padding: "24px" }}>
        {step === "input" && (
          <div>
            ...
            {d.branding.supportEmail || d.branding.supportPhone ? (
              ...
              >
                Need help?{" "}
                {d.branding.supportEmail && (
                  <span>
                    Email{" "}
                    <a
                      href={`mailto:${d.branding.supportEmail}`}
                      style={{
                        color: primary,
                        textDecoration: "none",
                        fontWeight: 500,
                ...
                {d.branding.supportEmail && d.branding.supportPhone && " | "}
                {d.branding.supportPhone && (
                  <span>
                    Call{" "}
                    <a
                      href={`tel:${d.branding.supportPhone}`}
                      style={{
                        color: primary,
                        textDecoration: "none",
                        fontWeight: 500,
        ...
        {step === "success" && (
          <div style={{ textAlign: "center" }}>
            ...
            >
              {d.description ||
                `This ${d.productName} has been verified as authentic.`}
            </p>
                  ...
                  >
                    ...
                    <div style={{ textAlign: "left" }}>
                      ...
                      <div style={{ fontSize: "12px", color: "#64748b" }}>
                        Receive {d.rewardAmount} Naira airtime for verifying
                        this product
                      </div>
                    </div>
                  </div>
                    ...
                    <div style={{ padding: "16px 20px" }}>
                      ...
                      >
                        ...
                        {detectedNetwork && (
                          ...
                          >
                            Credited as {d.rewardAmount} Naira airtime via{" "}
                            {detectedNetwork}
                          </p>
                        )}
                      </div>
        ...
        {step === "fail" && (
          <div style={{ textAlign: "center", padding: "24px 0" }}>
            ...
            >
              The scratch code entered does not match our records. This product
              may be counterfeit.
            </p>
            <button
              className="et-btn"
